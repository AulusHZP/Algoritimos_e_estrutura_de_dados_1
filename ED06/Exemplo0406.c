...
IO_println ( " 2 - definir se o valor inteiro e positivo" );
IO_println ( " 3 - definir se o valor positivo e menor que 100" );
IO_println ( " 4 - definir se o valor positivo e menor que 100 e par" );
IO_println ( " 5 - definir se o valor positivo e menor que 100 e par" );
IO_println ( " 6 - definir a quantidade de caracteres minusculos" );
IO_println ( " 7 - " );
IO_println ( " 8 - " );
IO_println ( " 9 - " );
IO_println ( "10 - " );
