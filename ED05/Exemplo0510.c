...
IO_println ( " 2 - Mostrar certa quantidade de valores pares01" );
IO_println ( " 3 - Mostrar certa quantidade de valores pares02" );
IO_println ( " 4 - Mostrar certa quantidade de valores pares03" );
IO_println ( " 5 - Mostrar certa quantidade de valores pares04" );
IO_println ( " 6 - Funcao para somar certa quantidade de pares" );
IO_println ( " 7 - Funcao para somar certa quantidade de fracoes01" );
IO_println ( " 8 - Funcao para somar certa quantidade de fracoes02" );
IO_println ( " 9 - Funcao para somar certa quantidade de fracoes03" );
