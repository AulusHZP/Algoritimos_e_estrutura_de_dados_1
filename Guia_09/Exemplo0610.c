...
// repetir até desejar parar
 ...
 IO_println ( " 6 - mostrar o somatorio de valores fracionarios" );
 IO_println ( " 7 - mostrar o somatorio de valores fracionarios (2)" );
 IO_println ( " 8 - contar o numero de digitos" );
 IO_println ( " 9 - mostrar os termos da serie de Fibonacci" );
 IO_println ( " 10 - contar as letras minusculas em uma cadeia de caracteres" );
 IO_println ( "" );
