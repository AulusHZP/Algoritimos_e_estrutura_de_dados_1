...
int main ( )
{
  ...
  do
  {
    ...
    IO_println ( "Opcoes" );
    IO_println ( " 0 - Parar" );
    IO_println ( " 1 - Gravar em um arquivo certa quantidade de valores inteiros" );
    IO_println ( " 2 - Ler de um arquivo certa quantidade de valores inteiros" );
    IO_println ( " 3 - Gravar em um arquivo certa quantidade de valores reais" );
    IO_println ( " 4 - Ler de um arquivo certa quantidade de valores reais" );
    IO_println ( " 5 - Gravar em um arquivo certa quantidade de valores, letras ou simbolos" );
    IO_println ( " 6 - Gravar em um arquivo certa quantidade de valores, letras ou simbolos" );
    IO_println ( " 7 - Copiar um arquivo" );
    IO_println ( " 8 - Gravar em um arquivo certa quantidade de valores, letras ou simbolos (2)" );
    IO_println ( " 9 - Ler de um arquivo certa quantidade de valores, letras ou simbolos (2)" );
    IO_println ( " 10 - Procurar valores, letras ou símbolos em um arquivo" );
    IO_println ( "" );
